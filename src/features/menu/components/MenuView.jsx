...
export const MenuView = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 py-6 animate-fadeIn space-y-6">
            ...
            {/* Botón Ver Carrito — separado del header, alineado a la derecha */}
            <div className="flex justify-end">
                <button
                    onClick={() => navigate('/portal/carrito')}
                    className="relative flex items-center gap-2 bg-[#e11d48] hover:bg-red-700 text-white font-black px-5 py-2.5 rounded-xl shadow-lg transition-all active:scale-95"
                >
